...
class DigimonDetailPage extends StatefulWidget {
  final F1Team constructor;
  DigimonDetailPage(this.constructor);
...
class _DigimonDetailPageState extends State<DigimonDetailPage> {
  ...
  void updateRating() {
    if (_sliderValue < 5) {
      ...
      setState(() {
        widget.constructor.rating = _sliderValue.toInt();
      });
    }
  }
    ...
    return new Hero(
      ...
      child: new Container(
        ...
        decoration: new BoxDecoration(
            ...
            //image: new DecorationImage(fit: BoxFit.cover, image: new NetworkImage(widget.constructor.imageUrl ?? ''))),
      ),
    ));
  }
  ...
  Widget get rating {
    return new Row(
      ...
      children: <Widget>[
        ...
        new Text('${widget.constructor.rating}/10', style: TextStyle(color: Colors.black, fontSize: 30.0))
      ],
    );
  }
  ...
  Widget get digimonProfile {
    return new Container(
      ...
      child: new Column(
        ...
        children: <Widget>[
          digimonImage,
          new Text('${widget.constructor.name}', style: TextStyle(color: Colors.black, fontSize: 32.0)),
          new Text('${widget.constructor.nationality}', style: TextStyle(color: Colors.black, fontSize: 20.0)),
          Padding(
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      appBar: new AppBar(
        ...
        title: new Text('Meet ${widget.constructor.name}'),
      ),
      body: new ListView(
